...
"in0=inf2/2"  ; Caliphatic RT evolution
"d0=3u"
...
;"spoff13=0" ; 13C adiabatic inversion
...
5 d12
  ...
  DELTA2 pl2:f2
#ifdef CA
  ;INEPT CB -> CA [with refocussing of CG2]
  (p3 ph12):f2
  DELTA2
  (p14:sp3 ph1):f2
  ;(p4 ph20):f2
...
; TESTING - t1 EVOLUTION WITHOUT CO/N DECOUPLING
;  d0 pl1:f1
;  (p2 ph1)
;  d0
 
  d0 pl1:f1
  (center (p2 ph1):f1 (p14:sp5 ph1):f2 (p22 ph1):f3 )
  d0
  (p14:sp3 ph1):f2
  ;adiabatic inversion:
  ;(p8:sp13 ph1):f2
...
;  (p4 ph1):f2
  ...
  d11 do:f2 mc #0 to 2
    F1PH(ip18, id10 & dd30)
    F2PH(rp18 & rd10 & rd30 & ip11 & ip12 & ip20, id0)
...
;sp9: f2 channel - 3ms CG2 inversion (Reburp.3k)
;p3 : f2 channel -  90 degree high power pulse
;p4 : f2 channel - 180 degree high power pulse
;p14: f2 channel - 180 degree shaped pulse [170 usec]
