;methyl 1H T2 measurement (3)
;L1-L3 lines (Tugarinov & Kay 2006)
;
...
"DELTA1=d2*0.5-4u-p16-d16-larger(p1,p3)-0.6366*p1"
"DELTA2=d2*0.5-4u-p16-d16-larger(p1,p3)-0.6366*p1-d12-4u"

define delay vdmin
"vdmin=4*(p1+p3+4u+p19+100u)"
...
2 d11 do:f2
  ...
  20u
  "TAU1=vd*0.25-4u-p19-100u-p3"
  "TAU2=vd*0.25-p3-p1"
  "TAU3=vd*0.25-p1-4u-p19-100u-p3"
  "TAU4=vd*0.25-p3"
...
# endif /*OFFRES_PRESAT*/
  ...
  ; mix slow->slow+fast and select fast relaxing lines
  (p1 ph1):f1 (p3 ph13):f2
  d3
  p17:gp4
  d16
  (center (p2 ph1):f1 (p4 ph1):f2 )
  ...
  ; convert back to in-phase magnetisation
  (p3 ph1):f2
  d3
  p17:gp5
  d16
