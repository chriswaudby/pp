...
;sp1: f1 channel - shaped pulse 90 degree flip-back (p11, H2O on resonance)
;sp2: f1 channel - shaped pulse 90 degree flip-down (p11, H2O on resonance)
;sp10: f1 channel - shaped pulse 90 degree watergate (p11, H2O on resonance)
...
;o2p: Cali chemical shift (36 ppm) 
;     choose CM sweep width so methyl centered at o2-sw
;     i.e. o2p = 36 ppm, sw = 19 ppm, methyls (folded once) centered at 17 ppm
;cnst21: 176 ppm
;sw (CO): 20 ppm = whole multiple from o2p (36 ppm)
;in0: 1/(SW(Ca)) =  DW(Ca)
;nd0: 1
